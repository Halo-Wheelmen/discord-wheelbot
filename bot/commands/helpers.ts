...
export async function installGlobalCommands(
  ...
  return await discordRequest<RESTPutAPIApplicationCommandsJSONBody>(
 ...
 */
export const getChannelAndMessageId = (
 ...
 */
function getUsername(interaction: APIApplicationCommandGuildInteraction) {
 ...
 */
export function auditLogHeader(interaction: APIApplicationCommandGuildInteraction) {
  return {
    'X-Audit-Log-Reason': `Action performed on behalf of user ${getUsername(interaction)}`,
  }
}
